                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-2 mt-2">
                                        @if (Auth::check())
                                        @php $data = Auth::user(); @endphp
                                            <h6 class="mb-0 mt-1 text-gray-700 align-items-center">{{ $data->nama }}</h6>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-md">
                                            <img src="{{ asset($data->profile_image) }}">
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                    <li>
                                        <h6 class="dropdown-header">Hello, {{ $data->nama }}!</h6>
                                    </li>
